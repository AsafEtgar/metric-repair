...
from metric_repair import (
    make_index_encoding, get_weights, all_pairs_distances, sorted_edges, _norm, _mvd_pivot_rec,
)
...
def on_broken_cycle(e, e_heavy, APSP_D, w_heavy, w_light):
    ...
    (Scalar reference for the vectorised get_truly_light_edges in metric_repair.py.)"""
    i, j = e
    x, y = e_heavy
